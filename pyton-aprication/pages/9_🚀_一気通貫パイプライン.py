...
"""
            ...
            with st.spinner("② 台本作成中..."):
                script_prompt = f"""以下の要約をもとに、動画・音声コンテンツの台本を作成してください。
...
# 出力形式（重要・必ず守ること）
- 話し言葉のセリフ調で、そのままナレーションとして読み上げられる文章のみを出力する
- 「##」「###」のような見出し記号や、「本編1：」「まとめ：」「冒頭フック：」のようなセクションラベルは一切書かない
- 「(目安時間：0分30秒)」のような時間の注記は一切書かない
- 「---」のような区切り線も書かない
